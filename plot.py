...
#             value_ssnet.append(float(line[2]))
    ...
    plt.plot(epochs_without, value_without,
             label="Modelv2-normal-res32x32-upsampling-2x-randomcrop-noshuffle", color='g')
    # plt.plot(epochs_alexnet, value_alexnet, label="Alexnet "+sys.argv[2], color='r')
    plt.plot(epochs_wgan, value_wgan,
             label="Modelv2-normal-res32x32-upsampling-2x-randomcrop-shuffle", color='b')
